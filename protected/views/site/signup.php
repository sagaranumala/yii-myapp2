    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <?php echo $form->textField($model,'name',array('class'=>'form-control','placeholder'=>'Full Name','required'=>true)); ?>
                <?php echo $form->error($model,'name'); ?>
            </div>

            <div class="mb-3">
                <?php echo $form->labelEx($model,'email'); ?>
                <?php echo $form->textField($model,'email',array('class'=>'form-control','placeholder'=>'Email','type'=>'email','required'=>true)); ?>
            ...
            <div class="mb-3">
                ...
                <?php echo $form->passwordField($model,'password_repeat',array('class'=>'form-control','placeholder'=>'Confirm Password','required'=>true)); ?>
                <?php echo $form->error($model,'password_repeat'); ?>
            </div>

            <div class="mb-3">
                <?php echo $form->labelEx($model,'role'); ?>
                <?php echo $form->dropDownList($model,'role',$model->getRoleOptions(),array('class'=>'form-control','empty'=>'-- Select Role --')); ?>
            ...
            <div class="mb-3">
                <?php echo CHtml::submitButton('Sign Up',array('class'=>'btn btn-primary','id'=>'submit-btn','disabled'=>true)); ?>
            </div>
...
$(document).ready(function(){
    ...
    $('input, select').on('input change', function(){
        let isValid = true;
        $('#signup-form input[required]').each(function(){ if($(this).val() === '') isValid=false; });
